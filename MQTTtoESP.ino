...
#define ssid "Your WiFi ssid" //ssid หรือชื่อของ WiFi ที่ต้องการเชื่อมต่อ
#define password "your WiFi password" //password หรือรหัสของ WiFi ที่ต้องการเชื่อมต่อ

const char* mqtt_server = "broker.emqx.io"; //ชื่อ Broker ที่ต้องการเชื่อมต่อ
...
void callback(char* topic, byte* payload, unsigned int length) 
 ...
 //สร้างฟังก์ชัน ในการตรวจสองการเชื่อมต่อกับโปโตคอล mqtt
  ...
  while (!client.connected()) {
    ...
    Serial.println(".");
    if (client.connect("Npru_Test_mqttIn")) //ทำการเชื่อมต่อ mqtt โดยที่ในวงเล็บคือชื่อที่สามารถตั้งได้ตามต้องการโดยที่ชื่อที่ตั้งไม่ควรซ้ำกันในจำนวนมาก
